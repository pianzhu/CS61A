...
def is_swap(player_score, opponent_score):
    ...
    if (opponent_score >= 10):
        ...
        tens_digit = 0
    if (abs(player_score % 10 - opponent_score % 10)) == tens_digit:
        return True
    else:
        return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (score0 < goal and score1 < goal):
        if (who == 0):
            ...
            this_score = take_turn(player0_strategy, score1, dice)
            if feral_hogs and abs(last_score0 - player0_strategy) == 2:
                score0 += 3
            last_score0 = this_score
            score0 += this_score
            if (is_swap(score0, score1)):
                score0, score1 = score1, score0
        else:
            player1_strategy = strategy1(score1, score0)
            this_score = take_turn(player1_strategy, score0, dice)
            if feral_hogs and abs(last_score1 - player1_strategy) == 2:
                score1 += 3
            score1 += this_score
